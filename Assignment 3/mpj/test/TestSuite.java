...
import mpj.*;
import mpj.ccl.*;
import mpj.ccl_ObjSer.*;
import mpj.ccl_ObjSer.allreduceO.*;
import mpj.ccl_ObjSer.reduceO.*;
import mpj.ccl_ObjSer.reduce_scatterO.*;
import mpj.ccl_ObjSer.scanO.*;
import mpj.comm.*;
import mpj.dtyp.*;
import mpj.dtyp_ObjSer.*;
import mpj.env.*;
import mpj.group.*;
import mpj.perf.*;
import mpj.pt2pt.*;
import mpj.pt2pt_ObjSer.*;
import mpj.signals.*;
import mpj.threads.*;
import mpj.topo.*;
import xdev.*;
